...
torchrun --standalone --nproc_per_node=4 -m scripts.base_train -- --depth=20 --run=$WANDB_RUN --device_batch_size=8
...
torchrun --standalone --nproc_per_node=4 -m scripts.mid_train -- --run=$WANDB_RUN --device_batch_size=8
...
torchrun --standalone --nproc_per_node=4 -m scripts.chat_sft -- --run=$WANDB_RUN --device_batch_size=8
